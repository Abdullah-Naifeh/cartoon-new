...
export default function UploadingAndDisplayingImage({ img }) {
  ...
  return (
    <div className="relative flex justify-center items-center w-full h-72 sm:h-96 text-center border rounded-lg">
      <div className="absolute top-0 left-0 flex flex-col justify-center items-center text-white  w-full">
      ...
      <div className="absolute top-0 mx-auto w-full h-72 sm:h-96 border-2 border-one rounded-lg overflow-hidden  ">
