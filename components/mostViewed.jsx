        ...
        >
          {showTip && (
            <div className=" flex items-center gap-2 my-2 w-fit bg-white/20 backdrop-blur-sm px-3 py-1.5 rounded-full text-white text-sm">
              <motion.div
                animate={isVertical ? { y: [0, 5, 0] } : { x: [0, 5, 0] }}
              ...
              {isVertical ? (
                <span className="select-none">اسحب للأعلى</span>
              ) : (
                <span className="select-none">اسحب لليمين</span>
              )}
            </div>
          )}
        </motion.div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {/* Episodes Badge */}
                    {item.episodes && (
                      <div className="absolute bottom-2 right-2 flex justify-center items-center gap-2 bg-black/60 backdrop-blur-sm rounded-full px-2 py-0.5">
